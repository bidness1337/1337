...
local Library do
    ...
    Library = {
        Flags = { },
        Theme = {
            ["Background"] = FromRGB(25, 28, 32),
["Inline"] = FromRGB(35, 38, 42),
["Page Background"] = FromRGB(45, 48, 52),
["First"] = FromRGB(35, 38, 42),
["Border"] = FromRGB(10, 13, 16),
["Outline"] = FromRGB(0, 0, 0),
["Accent"] = FromRGB(41, 128, 185),
["Element"] = FromRGB(50, 53, 57),
["Hovered Element"] = FromRGB(60, 63, 67),
...
Tween:Create(Gui, TweenInfo.new(0.17, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = Delta}, true)
    ...
    Library.Watermark = function(self, Name)
        ...
        local Items = { } do
            ...
            Instances:Create("UIGradient", {
                ...
                Rotation = 0,
                Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(0, 0, 0)), RGBSequenceKeypoint(0.5, Library.Theme.Accent), RGBSequenceKeypoint(1, FromRGB(0, 0, 0))}
            })
        end
    ...
    Library.Notification = function(self, Text, Duration, Color, Icon)
        local Items = { } do
            ...
            Instances:Create("UIGradient", {
                Parent = Items["AccentLine"].Instance,
                Rotation = 0,
                Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(0, 0, 0)), RGBSequenceKeypoint(0.5, Color), RGBSequenceKeypoint(1, FromRGB(0, 0, 0))}
            })
    ...
    -- =====================================================================
    -- WINDOW (modified: tab bar is now at the BOTTOM)
    -- =====================================================================
    Library.Window = function(self, Data)
        Data = Data or { }
        local Window = {
            Name = Data.Name or Data.name or "Window",
            Size = Data.Size or Data.size or UDim2New(0, 800, 0, 450),
        ...
        local Items = { } do
            ...
            }) Items["MainFrame"]:AddToTheme({BackgroundColor3 = "Inline", BorderColor3 = "Outline"})
            ...
            Instances:Create("UIGradient", {
                ...
                Color = ColorSequence.new({
                    ...
                    ColorSequenceKeypoint.new(1, Library.Theme["Page Background"])
                }),
                Rotation = 90
            })
            Items["AccentLine"] = Instances:Create("Frame", {
            ...
            Instances:Create("UIGradient", {
                ...
                Rotation = 0,
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, FromRGB(0, 0, 0)),
                    ColorSequenceKeypoint.new(0.5, Library.Theme.Accent),
                    ColorSequenceKeypoint.new(1, FromRGB(0, 0, 0))
                })
            })
            Items["Title"] = Instances:Create("TextLabel", {
                Parent = Items["MainFrame"].Instance,
            ...
            Items["ExitButton"] = Instances:Create("TextButton", {
                Parent = Items["MainFrame"].Instance,
                FontFace = Library.Font,
                TextColor3 = FromRGB(215, 215, 215),
                BorderColor3 = FromRGB(0, 0, 0),
                ...
                BackgroundColor3 = FromRGB(50, 53, 57),
                Position = UDim2New(1, -15, 0, 2.5),
                BorderSizePixel = 0,
                TextSize = 12,
                AutoButtonColor = false,
                BackgroundTransparency = 1
            })
            Items["ExitButton"]:AddToTheme({TextColor3 = "Text", BackgroundColor3 = "Element"})
            Instances:Create("UIStroke", {
            ...
            Items["ExitButton"]:OnHover(function()
                Items["ExitButton"]:Tween(nil, {BackgroundColor3 = Library.Theme["Hovered Element"]})
                Items["ExitButton"]:ChangeItemTheme({BackgroundColor3 = "Hovered Element"})
            end)
            Items["ExitButton"]:OnHoverLeave(function()
                Items["ExitButton"]:Tween(nil, {BackgroundColor3 = Library.Theme["Element"]})
                Items["ExitButton"]:ChangeItemTheme({BackgroundColor3 = "Element"})
            end)
            Items["ExitButton"]:Connect("MouseButton1Down", function()
                Window:SetOpen(false)
            end)

            -- Content area (full width since tabs moved to bottom)
            Items["Content"] = Instances:Create("Frame", {
                Parent = Items["MainFrame"].Instance,
                Name = "\0",
                Position = UDim2New(0, 14, 0, 27),
                BorderColor3 = FromRGB(10, 10, 10),
                Size = UDim2New(1, -28, 1, -70), -- leaves ~43px at the bottom for the tab bar
                BorderSizePixel = 2,
                BackgroundColor3 = FromRGB(15, 15, 20)
            }) Items["Content"]:AddToTheme({BackgroundColor3 = "First", BorderColor3 = "Border"})
            Instances:Create("UIStroke", {
                Parent = Items["Content"].Instance,
                LineJoinMode = Enum.LineJoinMode.Miter,
                ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
            ...
            Items["Pages"] = Instances:Create("Frame", {
                ...
                Name = "\0",
                BackgroundTransparency = 1,
                Position = UDim2New(0, 14, 1, -38),
                Size = UDim2New(1, -28, 0, 30),
                BorderColor3 = FromRGB(0, 0, 0),
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(255, 255, 255)
            })
    ...
    -- =====================================================================
    -- PAGE (modified: each page button has fixed width for the bottom bar)
    -- =====================================================================
    Library.Page = function(self, Data)
        ...
        local Items = { } do
            Items["Inactive"] = Instances:Create("TextButton", {
                ...
                AutoButtonColor = false,
                Name = "\0",
                Size = UDim2New(0, 120, 1, 0), -- fixed width for horizontal layout
                BorderSizePixel = 2,
                TextSize = 14,
            ...
            local stroke = Items["Inactive"].Instance:FindFirstChildOfClass("UIStroke")
            if stroke then
            ...
            if not Page.HasSubtabs then
                ...
                Items["Columns"] = Instances:Create("Frame", {
                    Parent = Items["Page"].Instance,
                    Name = "\0",
                    Position = UDim2New(0, 7, 0, 42),
                    BorderColor3 = FromRGB(10, 10, 10),
                    Size = UDim2New(1, -14, 1, -49),
                    BorderSizePixel = 2,
                    BackgroundColor3 = FromRGB(15, 15, 20)
    ...
    Library.Pages.MultiSection = function(self, Data)
        ...
        for Index, Value in MultiSection.Sections do
            ...
            local SubItems = { } do
                ...
                SubItems["Inactive"].Instance.BackgroundTransparency = 1
                local stroke = SubItems["Inactive"].Instance:FindFirstChildOfClass("UIStroke")
            ...
            function NewSection:Turn(Bool)
                ...
                if Bool then
                    ...
                    SubItems["Inactive"].Instance.BackgroundTransparency = 0
                    local stroke = SubItems["Inactive"].Instance:FindFirstChildOfClass("UIStroke")
    ...
    Library.Sections.Dropdown = function(self, Data)
        ...
        function Dropdown:Add(Option)
            ...
            function OptionData:Toggle(State)
                if State == "Active" then
                    ...
                    OptionData.Text:Tween(nil, {TextColor3 = Library.Theme.Text, TextTransparency = 0})
                else
                    OptionData.Text:ChangeItemTheme({TextColor3 = "Text"})
        ...
        function Dropdown:SetOpen(Bool)
            ...
            for Index, Value in Descendants do
                ...
                if type(ValueIndex) == "table" then
                    for _, Property in ValueIndex do
                        NewTween = Library:FadeItem(Value, Property, Bool, 0.15)
                    end
                else
                    NewTween = Library:FadeItem(Value, ValueIndex, Bool, 0.15)
                end
            end
            Library:Connect(NewTween.Tween.Completed, function()
                Debounce = false
