...
local Library do
    ...
    Library = {
        ...
        Theme = {
            ...
            ["Hovered Element"] =  FromRGB(0, 0, 0),
            ["Text"] = FromRGB(220, 225, 230),
        ...
        CurrentConfigPopup = nil,
        
        LastWindowPosition = nil, -- NEW: Track window position for popups
        WindowInstance = nil -- NEW: Reference to main window
    }
    ...
    Library.CreateFadingAccentLine = function(self, ParentFrame, ThemeColor)
        ...
        local AccentLine = Instances:Create("Frame", {
            ...
            BorderSizePixel = 0,
            BackgroundColor3 = self.Theme[ThemeColor]
        }) 
        
        AccentLine:AddToTheme({BackgroundColor3 = ThemeColor})
        
        -- Create gradient that fades from black to accent color to black
        local Gradient = Instances:Create("UIGradient", {
            Parent = AccentLine.Instance,
            Rotation = 0, -- Horizontal gradient
            Color = RGBSequence{
                RGBSequenceKeypoint(0, FromRGB(0, 0, 0)),          -- Left: Black
                RGBSequenceKeypoint(0.5, self.Theme[ThemeColor]), -- Middle: Theme Color
                RGBSequenceKeypoint(1, FromRGB(0, 0, 0))          -- Right: Black
            }
        })
        ...
        for _, Item in self.ThemeItems do
            for Property, Value in Item.Properties do
                if type(Value) == "string" and Value == Theme then
                    ...
                    -- Update gradient if it exists on this item
                    local Gradient = Item.Item:FindFirstChildOfClass("UIGradient")
                    if Gradient then
                        -- Update the middle keypoint to the new color
    ...
    Library.Watermark = function(self, Name)
        ...
        local Items = { } do 
            ...
            Items["AccentLine"] = Library:CreateFadingAccentLine(Items["Watermark"].Instance, "Accent")
        end
    ...
    Library.KeybindList = function(self)
        ...
        local Items = { } do
            ...
            Items["AccentLine"] = Library:CreateFadingAccentLine(Items["KeybindList"].Instance, "Accent")
    ...
    Library.CreateColorpicker = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["AccentLine"] = Library:CreateFadingAccentLine(Items["ColorpickerWindow"].Instance, "Accent")
    ...
    Library.Window = function(self, Data)
        ...
        local Items = { } do 
            ...
            Items["Inline"] = Instances:Create("Frame", {
                Parent = Items["MainFrame"].Instance,
                Name = "\0",
                Position = UDim2New(0, 7, 0, 25),
                BorderColor3 = FromRGB(27, 27, 32),
                Size = UDim2New(1, -14, 1, -32),
                BorderSizePixel = 2,
            ...
            Items["Content"] = Instances:Create("Frame", {
                Parent = Items["Inline"].Instance,
                Name = "\0",
                Position = UDim2New(0, 138, 0, 7),
                BorderColor3 = FromRGB(10, 10, 10),
                Size = UDim2New(1, -146, 1, -14),
                BorderSizePixel = 2,
                BackgroundColor3 = FromRGB(15, 15, 20)
        ...
        function Window:SetOpen(Bool)
            ...
            if Bool then 
                ...
                -- Update window position reference
                Library.LastWindowPosition = Items["MainFrame"].Instance.Position
            end
            ...
            Library:Connect(NewTween.Tween.Completed, function()
                ...
                -- Update popup positions when window closes/opens
    ...
    Library.Page = function(self, Data)
        ...
        local Items = { } do 
            Items["Inactive"] = Instances:Create("TextButton", {
                Parent = Page.Window.Elements["Sidebar"].Instance,
                FontFace = Library.Font,
                TextColor3 = FromRGB(0, 0, 0),
                BorderColor3 = FromRGB(10, 10, 10),
                Text = "",
            ...
            Items["TabOutline"] = Instances:Create("UIStroke", {
                ...
                Name = "\0",
                Transparency = 1
            })  Items["TabOutline"]:AddToTheme({Color = "Outline"})
        ...
        function Page:Turn(Bool)
            ...
            -- Close any open config popups when switching tabs
            ...
            if Bool then 
                ...
                Items["TabOutline"]:Tween(nil, {Transparency = 0})
                ...
                Items["TabOutline"]:Tween(nil, {Transparency = 1})
    ...
    Library.Pages.SubPage = function(self, Data)
        ...
        function SubPage:Turn(Bool)
            ...
            -- Close any open config popups when switching subtabs
            if Bool and Library.CurrentConfigPopup then
                Library.CurrentConfigPopup:SetOpen(false)
                Library.CurrentConfigPopup = nil
            end
    ...
    Library.Pages.MultiSection = function(self, Data)
        ...
        for Index, Value in MultiSection.Sections do 
            ...
            function NewSection:Turn(Bool)
                ...
                -- Close any open config popups when switching multisections
                if Bool and Library.CurrentConfigPopup then
                    Library.CurrentConfigPopup:SetOpen(false)
                    Library.CurrentConfigPopup = nil
                end
    ...
    -- UPDATED CONFIGURATION POPUP SYSTEM WITH ALL FIXES
    Library.CreateConfigPopup = function(self, Data)
        Data = Data or { }
        ...
        local ConfigPopup = {
            ...
            Elements = { },
            ConfigElements = { },
            StoredPosition = nil, -- Store position for when window moves
            StoredSize = nil -- Store size for resizing
        }
        
        setmetatable(ConfigPopup, ConfigPopup)
        
        local Items = { } do
            Items["ConfigWindow"] = Instances:Create("Frame", {
                Parent = Library.Holder.Instance,
                BorderColor3 = FromRGB(10, 10, 10),
                Name = "\0ConfigWindow",
                Position = UDim2New(0, 0, 0, 0),
            ...
            })  Items["ConfigWindow"]:AddToTheme({BackgroundColor3 = "Background", BorderColor3 = "Border"})
        ...
        function ConfigPopup:AddSlider(Data)
            ...
            local SliderMax = Data.Max or Data.max or 100
            local SliderDefault = Data.Default or Data.default or SliderMin
            local SliderDecimals = Data.Decimals or Data.decimals or 1
            ...
            local function UpdateSlider(Value)
                Value = math.clamp(math.round(Value, SliderElement.Decimals), SliderElement.Min, SliderElement.Max)
            ...
            -- Mouse interaction
            local Sliding = false
            RealSlider:Connect("MouseButton1Down", function()
                Sliding = true
                local MousePos = UserInputService:GetMouseLocation()
                local SizeX = (MousePos.X - RealSlider.Instance.AbsolutePosition.X) / RealSlider.Instance.AbsoluteSize.X
        ...
        function ConfigPopup:AddColorpicker(Data)
            ...
            ColorButton:Connect("MouseButton1Down", function()
                ...
                -- Ensure colorpicker window is above other elements
        ...
        function ConfigPopup:AddKeybind(Data)
            ...
            KeybindButton:Connect("MouseButton1Click", function()
                if KeybindElement.Picking then 
                    return
                end
            ...
            ConfigPopup.ConfigElements[KeybindName] = KeybindElement
        ...
        function ConfigPopup:AddDropdown(Data)
            ...
            local function SetDropdownOpen(Bool)
                ...
                if Bool then
                    ...
                    local dropdownPos = RealDropdown.Instance.AbsolutePosition
            ...
            -- Create dropdown options (compact version for popup)
            for Index, Option in ipairs(DropdownItems) do
                local OptionButton = Instances:Create("TextButton", {
                    ...
                    BackgroundTransparency = 1,
                    BorderSizePixel = 0,
                    Size = UDim2New(1, 0, 0, 12), -- Smaller for popup
                    ZIndex = 10011,
                    TextSize = 14,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                ...
                local OptionText = Instances:Create("TextLabel", {
                    ...
                    BorderSizePixel = 0,
                    ZIndex = 10011,
                    TextSize = 11, -- Smaller font for popup
                    BackgroundColor3 = FromRGB(255, 255, 255)
                }) 
            ...
            Library:Connect(UserInputService.InputBegan, function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    if not DropdownElement.IsOpen then
                        return 
                    end

                    if Library:IsMouseOverFrame(OptionHolder) then
                        return
                    end
            ...
            ConfigPopup.ConfigElements[DropdownName] = DropdownElement
        ...
        function ConfigPopup:SetConfig(ConfigName, Value)
            if self.ConfigElements[ConfigName] then
                ...
                if Element.Type == "slider" then
                    -- Update slider value
                    local function UpdateSlider(Value)
                        Value = math.clamp(math.round(Value, Element.Decimals), Element.Min, Element.Max)
                        Element.Value = Value
                        
                        local Percent = (Value - Element.Min) / (Element.Max - Element.Min)
                        Element.Indicator:Tween(TweenInfo.new(0.17, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), 
                            {Size = UDim2New(Percent, 0, 1, 0)})
                        
                        Element.ValueLabel.Instance.Text = tostring(Value) .. Element.Suffix
                        
                        if Element.Callback then
                            Library:SafeCall(Element.Callback, Value)
                        end
                    end
                ...
                elseif Element.Type == "toggle" then
                    local function SetToggle(Bool)
                        ...
                        if Element.Callback then 
                            Library:SafeCall(Element.Callback, Element.Value)
                        end
                    end
        ...
        function ConfigPopup:SetOpen(Bool)
            ...
            if Bool then
                -- Position the popup next to the parent button
                local parentPos = ConfigPopup.Parent.Instance.AbsolutePosition
                local parentSize = ConfigPopup.Parent.Instance.AbsoluteSize
                local screenSize = workspace.CurrentCamera.ViewportSize
                
                -- Calculate position (try to fit on screen)
                local popupWidth = 220 -- Fixed width for config popup
                ...
                -- Update content size before positioning
                ...
                local popupHeight = contentHeight + 50 -- Add padding for title and margins
                
                -- Make sure it doesn't go below screen
                ...
                ConfigPopup.StoredSize = Items["ConfigWindow"].Instance.Size
                
                -- Store position relative to main window
                local mainWindowPos = Library.WindowInstance and Library.WindowInstance.Instance.AbsolutePosition or parentPos
                local offsetX = x - mainWindowPos.X
                local offsetY = y - mainWindowPos.Y
                
                ConfigPopup.StoredPosition = {
                    X = offsetX,
                    Y = offsetY,
                    Absolute = UDim2.new(0, x, 0, y)
                }
                
                Items["ConfigWindow"].Instance.Position = ConfigPopup.StoredPosition.Absolute
                
                -- Close any other open config popups
                if Library.CurrentConfigPopup and Library.CurrentConfigPopup ~= self then
                    Library.CurrentConfigPopup:SetOpen(false)
                end
                Library.CurrentConfigPopup = self
                
                Items["ConfigWindow"].Instance.Visible = true
                Items["ConfigWindow"].Instance.BackgroundTransparency = 1
                
                -- Set all children to transparent initially
                ...
                -- Fade in
                Items["ConfigWindow"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                    {BackgroundTransparency = 0})
                ...
                for _, child in Items["ConfigWindow"].Instance:GetDescendants() do
                    if child:IsA("UIStroke") then
                        Tween:Create(child, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                            {Transparency = 0}, true)
                    elseif child:IsA("TextLabel") or child:IsA("TextButton") or child:IsA("TextBox") then
                        if child:IsA("TextLabel") or child:IsA("TextBox") then
                            Tween:Create(child, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                                {TextTransparency = 0}, true)
                        end
                        if child:IsA("Frame") and child ~= Items["ConfigWindow"].Instance then
                            local targetTransparency = child.BackgroundTransparency == 1 and 1 or 0
                            Tween:Create(child, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                                {BackgroundTransparency = targetTransparency}, true)
                        end
                    elseif child:IsA("ImageLabel") then
                        Tween:Create(child, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                            {ImageTransparency = 0}, true)
                    end
                end
            else
                -- Fade out
                for _, child in Items["ConfigWindow"].Instance:GetDescendants() do
                    if child:IsA("UIStroke") then
                        Tween:Create(child, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                            {Transparency = 1}, true)
                    elseif child:IsA("TextLabel") or child:IsA("TextButton") or child:IsA("TextBox") then
                        if child:IsA("TextLabel") or child:IsA("TextBox") then
                            Tween:Create(child, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                                {TextTransparency = 1}, true)
                        end
                        if child:IsA("Frame") then
                            Tween:Create(child, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                                {BackgroundTransparency = 1}, true)
                        end
                    elseif child:IsA("ImageLabel") then
                        Tween:Create(child, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                            {ImageTransparency = 1}, true)
                    end
                end
                
                task.wait(0.15)
                
                Items["ConfigWindow"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
                    {BackgroundTransparency = 1})
            ...
            for _, ConfigName in ipairs(configNames) do
                ...
                if ConfigType == "slider" then
                    ConfigPopup:AddSlider({
                        ...
                        Decimals = ConfigOptions.Decimals,
    ...
    Library.Sections.Toggle = function(self, Data)
        ...
        local Items = { } do 
            ...
            -- Add settings button if config is provided
            if Toggle.HasConfig then
                Items["ConfigButton"] = Instances:Create("ImageButton", {
                    Parent = Items["Toggle"].Instance,
                    Image = "rbxassetid://81593156472608", -- Gear/settings icon
                ...
                if Toggle.ConfigPopup and Toggle.ConfigPopup.Elements and Toggle.ConfigPopup.Elements["ConfigWindow"] then
                    Toggle.ConfigPopup.Elements["ConfigWindow"].Instance.Visible = false
                    Toggle.ConfigPopup.IsOpen = false
                end
            end
        ...
        function Toggle:Set(Bool)
            ...
            -- Ensure config button is properly positioned
            if Items["ConfigButton"] then
                Items["ConfigButton"].Instance.Position = UDim2New(1, -2, 0.5, 0)
                Items["ConfigButton"].Instance.Size = UDim2New(0, 12, 0, 12)
            end
        end
        ...
        -- NEW: Get configuration value
        function Toggle:GetConfig(ConfigName)
            if Toggle.ConfigPopup then
                return Toggle.ConfigPopup:GetConfig(ConfigName)
            end
            return nil
        end
        
        -- NEW: Set configuration value
        function Toggle:SetConfig(ConfigName, Value)
            if Toggle.ConfigPopup then
                Toggle.ConfigPopup:SetConfig(ConfigName, Value)
            end
        end
        
        -- NEW: Open configuration popup
        function Toggle:OpenConfig()
            if Toggle.ConfigPopup then
                Toggle.ConfigPopup:SetOpen(true)
            end
        end
        
        -- NEW: Close configuration popup
        ...
        if Toggle.HasConfig then
            Items["ConfigButton"]:Connect("MouseButton1Down", function()
                if Toggle.ConfigPopup then
                    ...
                    local isOpening = not Toggle.ConfigPopup.IsOpen
                    Toggle.ConfigPopup:SetOpen(isOpening)
                    
                    -- Close other popups if opening this one
                    if isOpening and Library.CurrentConfigPopup and Library.CurrentConfigPopup ~= Toggle.ConfigPopup then
                        Library.CurrentConfigPopup:SetOpen(false)
                    end
                end
            end)
    ...
    Library.Sections.Dropdown = function(self, Data)
        ...
        local Items = { } do
            ...
            -- FIXED: Changed parent to Library.Holder.Instance to ensure it's above other elements
        ...
        function Dropdown:SetVisibility(Bool)
            ...
            if not Bool and Items["OptionHolder"] then
        ...
        function Dropdown:SetOpen(Bool)
            ...
            if Bool then 
                -- Position the OptionHolder correctly
                ...
                Items["OptionHolder"].Instance.Position = UDim2New(
                    0, dropdownPos.X,
                    0, dropdownPos.Y + dropdownSize.Y + 2
                )
        ...
        Library:Connect(UserInputService.InputBegan, function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                ...
                -- Check if click is inside the OptionHolder
                local mousePos = Vector2.new(Input.Position.X, Input.Position.Y)
                local optionPos = Items["OptionHolder"].Instance.AbsolutePosition
                local optionSize = Items["OptionHolder"].Instance.AbsoluteSize
                
                local isInsideOptionHolder = 
                    mousePos.X >= optionPos.X and 
                    mousePos.X <= optionPos.X + optionSize.X and
                    mousePos.Y >= optionPos.Y and 
                    mousePos.Y <= optionPos.Y + optionSize.Y
                
                -- Check if click is inside the dropdown button itself
                local dropdownPos = Items["RealDropdown"].Instance.AbsolutePosition
                local dropdownSize = Items["RealDropdown"].Instance.AbsoluteSize
                ...
                if not isInsideOptionHolder and not isInsideDropdown then
                    Dropdown:SetOpen(false)
                end
            end
        end)
