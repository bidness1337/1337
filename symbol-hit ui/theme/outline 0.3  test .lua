    ...
    return setmetatable(Window, Library)
        ...
        function Library.Section(self, cfg)
            ...
            do
                ...
                -- Add hover effects for section title
                Utility.Signal(Objects.TopBackground.MouseEnter:Connect(function()
                    if not Section.Resizing then
                ...
                Utility.Signal(Objects.TopBackground.MouseLeave:Connect(function()
                    if not Section.Resizing then
                        Library.ChangeObjectTheme(Objects.Title, {
                            TextColor3 = 'Text',
                        }, true)
                ...
                Objects.Padded = Utility.New('Frame', {
                    ...
                    BorderSizePixel = 0,
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, -12, 1, -(Objects.TopBackground.AbsoluteSize.Y + 12)),
                    Position = UDim2.new(0, 6, 0, Objects.TopBackground.AbsoluteSize.Y + 6),
                    Parent = Objects.Outline,
                    ZIndex = ZIndex,
                })
                ZIndex = ZIndex + 1
