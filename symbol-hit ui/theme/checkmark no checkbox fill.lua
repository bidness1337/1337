...
[[ from GitHub. Make sure the file exists in the assets folder or on GitHub.]])
    ...
    local Library = {
        ...
        Checkmark = 'rbxassetid://10709790644', -- Checkmark image ID
        Converts = {
            [0] = '0',
            '1',
            '2',
    ...
    do
        ...
        function Library.UpdateTheme(theme, color)
            ...
            -- Update checkmark colors if accent changes
            if theme == 'Accent' then
                -- Find all toggle icons and update their color
...
-cfg.size.Y.Offset / 2),
        ...
        function Library.Toggle(self, cfg)
            ...
            function Toggle.Set(value)
                ...
                -- Don't change background color (keep it as Background)
                -- Just update the checkmark visibility and color
                if Objects.Icon then
