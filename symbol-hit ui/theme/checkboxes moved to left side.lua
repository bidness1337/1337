...
function Library.Section(self, cfg)
    ...
    do
        ...
        Utility.New('UIListLayout', {
            ...
            Padding = UDim.new(0, 6), -- Space between checkbox and text
        })
        
        -- Checkbox outline (now on the LEFT side)
        Objects.Outline = Utility.New('Frame', {
            Name = 'Outline',
            Size = UDim2.new(0, 18, 0, 18), -- Fixed size for checkbox
            Position = UDim2.fromOffset(0, 0),
            BorderSizePixel = 0,
        ...
        Utility.New('UICorner', {
            Name = 'UICorner',
            CornerRadius = UDim.new(0, 4), -- Slightly smaller radius for checkbox
            Parent = Objects.Outline,
        })
        ...
        -- Text label (now to the RIGHT of the checkbox)
        Objects.Text = Utility.New('TextLabel', {
            Name = 'Text',
            TextStrokeTransparency = 0.8,
            BackgroundTransparency = 1,
            TextSize = Library.FontSize,
            FontFace = Library.Font,
            Size = UDim2.new(1, -30, 0, 0), -- Take remaining width
            AutomaticSize = Enum.AutomaticSize.Y,
            Text = cfg.name,
            TextXAlignment = Enum.TextXAlignment.Left,
            Parent = Objects.TextLine,
        ...
        if cfg.children ~= nil then
            ...
            Utility.New('UIPadding', {
                Name = 'UIPadding',
                PaddingLeft = UDim.new(0, 24), -- Indent to align with text
