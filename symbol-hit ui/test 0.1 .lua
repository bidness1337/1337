...
local Library = (function()
        ...
        function AssetLoader:LoadAsset(assetName)
            ...
            if isfile(filePath) then
                ...
                if success and data then
                    ...
                    warn('[AssetLoader] Failed to load ' .. fileName .. [[ from GitHub. Make sure the file exists in the assets folder or on GitHub.]])
                    return nil
                end
            end
        end
    ...
    do
        ...
        -- NEW: generic drag helper used by Watermark and KeybindList
        ...
        function Library.Tab(self, cfg)
            ...
            function Tab.Set(status, nested)
                ...
                if status then
                    ...
                    if Objects.Icon then
                        Library.ChangeObjectTheme(Objects.Icon, { ImageColor3 = 'Text' }, true)
                    end
                else
                    ...
                    if Objects.Icon then
                        Library.ChangeObjectTheme(Objects.Icon, { ImageColor3 = 'Dark Text' }, true)
                    end
                end
        ...
        function Library.Dropdown(self, cfg)
            ...
            function Dropdown.Add(name)
                ...
                function Item.Select(value)
                    Library.ChangeObjectTheme(Objects.Text, { TextColor3 = value and 'Text' or 'Dark Text' }, true)
                    Item.Selected = value
                end
        ...
        function Library.Keybind(self, cfg)
            ...
            -- NEW: register for the keybind list
            ...
            function Keybind.Set(value, ignore)
                ...
                -- NEW: push update to the on-screen keybind list
        ...
        ---------------------------------------------------------------
        -- WATERMARK (draggable + attach-to-gui)
        ---------------------------------------------------------------
        function Library.Watermark(cfg)
            ...
            function Watermark.SetAttachToGui(attach)
                ...
                if attach then
                    ...
                    if Watermark.SavedPosition then
            ...
            -- Find the main window frame (looks for Outline with SideContainer + PageHolder)
            local function FindMainWindow()
                for _, desc in ipairs(game:GetService('CoreGui'):GetDescendants())do
                    if desc.Name == 'Outline' and desc:FindFirstChild('SideContainer') and desc:FindFirstChild('PageHolder') then
                        return desc
                    end
                end
                return nil
                ...
                if Watermark.AttachToGui and Watermark.Visible and not Watermark.Dragging then
                    ...
                    if mainWindow then
                        Objects.Outline.Position = UDim2.new(
                            0,
                            mainWindow.AbsolutePosition.X + (mainWindow.AbsoluteSize.X / 2) - (Objects.Outline.AbsoluteSize.X / 2),
                            0,
        ...
        function Library.KeybindList(cfg)
            ...
            function KeybindList.Add(flag, displayName, key, mode)
                if table.find(KeybindList.Blacklist, flag) then
                    return
                end
                ...
                function Entry.Set(name, key, mode)
                    E.Name.Text = name .. ':'
                    E.Key.Text = GetKeyName(key) .. (mode == 'Hold' and ' [Hold]' or '')
                end
            ...
            function KeybindList.Rebuild()
                ...
                for _, flag in ipairs(Library.KeybindFlags)do
                    ...
                    if data and data.key then
                        KeybindList.Add(flag, flag, data.key, data.mode)
                    end
                end
            end
