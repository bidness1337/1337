...
local Library do
    ...
    Library = {
        ...
        Theme = {
            ["Background"] = FromRGB(237, 231, 238),      -- #EDE7EE light lavender-pink window bg
            ["Inline"] = FromRGB(255, 255, 255),           -- #FFFFFF white panel bg
            ["Page Background"] = FromRGB(245, 238, 243),  -- #F5EEF3 tab button bg
            ["Border"] = FromRGB(221, 208, 216),           -- #DDD0D8 soft pink-gray border
            ["Outline"] = FromRGB(213, 194, 204),          -- #D5C2CC slightly deeper outline
            ["Accent"] = FromRGB(224, 149, 176),           -- #E095B0 pink accent
            ["Element"] = FromRGB(240, 234, 240),          -- #F0EAF0 element bg
            ["Hovered Element"] = FromRGB(232, 221, 230),  -- #E8DDE6 hovered element
            ["Text"] = FromRGB(58, 42, 53),                -- #3A2A35 dark text for light bg
            ["Text Border"] = FromRGB(240, 234, 240)       -- very subtle text border
        },
    ...
    Library.CreateKeybind = function(self, Data)
        ...
        local Items = { } do 
            ...
            Items["Toggle"] = Instances:Create("TextButton", {
                Parent = Items["Window"].Instance,
                FontFace = Library.Font,
                TextColor3 = FromRGB(224, 149, 176),
                BorderColor3 = FromRGB(0, 0, 0),
                Text = "Toggle",
                AutoButtonColor = false,
                Name = "\0",
    ...
    Library.Window = function(self, Data)
        ...
        local Items = { } do 
            ...
            Items["AccentBorder"] = Instances:Create("UIStroke", {
                ...
                LineJoinMode = Enum.LineJoinMode.Miter,
                Name = "\0",
                Color = FromRGB(224, 149, 176)
            })  Items["AccentBorder"]:AddToTheme({Color = "Accent"})
            
            -- ── Inner container fills the whole window ──
            ...
            -- ── Tab row spans full width at the top ──
            ...
            -- ── Content area: between tab separator and status bar ──
            Items["Content"] = Instances:Create("Frame", {
                Parent = Items["Inline"].Instance,
                Name = "\0",
                Position = UDim2New(0, 4, 0, 35),
                BorderColor3 = FromRGB(10, 10, 10),
                Size = UDim2New(1, -8, 1, -57),
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(15, 15, 20)
            })  Items["Content"]:AddToTheme({BackgroundColor3 = "Background"})

            -- ── Status bar separator above the window title ──
            Instances:Create("Frame", {
                Parent = Items["Inline"].Instance,
                Name = "\0",
                AnchorPoint = Vector2New(0, 1),
            ...
            -- ── Window name in the status bar (bottom-left) ──
            Items["Title"] = Instances:Create("TextLabel", {
                Parent = Items["Inline"].Instance,
                FontFace = Library.Font,
                TextColor3 = FromRGB(58, 42, 53),
                BorderColor3 = FromRGB(0, 0, 0),
                Text = Window.Name,
                Name = "\0",
                AnchorPoint = Vector2New(0, 1),
                Size = UDim2New(0.5, -8, 0, 14),
                BackgroundTransparency = 1,
                TextXAlignment = Enum.TextXAlignment.Left,
            ...
            if not Page.HasSubtabs then 
                ...
                for Index = 1, Page.Columns do
                    local NewColumn = Instances:Create("ScrollingFrame", {
                        Parent = Items["Page"].Instance,
                        ScrollBarImageColor3 = FromRGB(224, 149, 176),
                        Active = true,
    ...
    Library.Pages.SubPage = function(self, Data)
        ...
        local Items = { } do
            ...
            -- Removed the UIGradient from subtab buttons to eliminate gradients on multi-tabs
    ...
    Library.Pages.MultiSection = function(self, Data)
        ...
        for Index, Value in MultiSection.Sections do 
            ...
            local SubItems = { } do 
                ...
                -- Removed the UIGradient from multi-section buttons to eliminate gradients
